...
#   timestamp: 2025-06-28T14:51:52+00:00
...
class CertificateParameters(BaseModel):
    ...
    MobileNoRQ: str = Field(
        ...,
        description='Mobile No./Requisition No.',
        examples=[
            'DigiLocker will only fetch the latest report if multiple laboratory reports are found.'
        ],
    )
...
class LabrpCertificatePostRequest(BaseModel):
...
class LabrpCertificatePostResponse(BaseModel):
...
class LabrpCertificatePostResponse1(BaseModel):
...
class LabrpCertificatePostResponse2(BaseModel):
...
class LabrpCertificatePostResponse3(BaseModel):
...
class LabrpCertificatePostResponse4(BaseModel):
...
class LabrpCertificatePostResponse5(BaseModel):
...
class LabrpCertificatePostResponse6(BaseModel):
